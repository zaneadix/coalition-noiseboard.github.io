...
export class NoisePreview {
  ...
  static fromData(data) {
    return Object.assign(new NoisePreview(), data);
  }
}
...
export class Noise {
  constructor() {
    ...
    this.defaults = Noise.initDefaults();
  }
  ...
  step(soundId) {
    ...
    if (this.howl && this.howl.playing(soundId)) {
      ...
      this.playbackPercentages = Object.assign({}, this.playbackPercentages);
    }
  }
  ...
  set source(src) {
    this.howl = new Howl(Object.assign({ src: [src] }, this.defaults));
  ...
  static fromData(data) {
    ...
    const defaults = data.defaults || noise.defaults;
    const returnValue = Object.assign(noise, data, defaults);
    return returnValue;
  }
}
