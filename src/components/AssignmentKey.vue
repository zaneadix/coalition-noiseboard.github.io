...
<template>
    ...
    <div class="key assignment-key" v-on:click="checkClick($event, 'assign')">
        <div class="key-body" ref="keyBody" @mouseenter="hover = true" @mouseleave="hover = false">

            <button class="unassigner icon-button" ref="unassignerBtn" v-if="hover && noise" v-on:click="checkClick($event, 'unassign')">
